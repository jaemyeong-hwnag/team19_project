...
<br/>
	<h3 class="agile-title">약관 동의</h3><br/>
	<p><span><i class="fa fa-weibo sub-w3l" aria-hidden="true"></i></span></p>
</div>
...
<pre class="pre-scrollable" style="max-height: 75vh">
	...
	제 1 조 (목적)
	이 약관은 team19(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
<div align="center">	
	...
	<a href="/~team19/signup/add" class="btn">동의 및 회원가입</a>
</div>
