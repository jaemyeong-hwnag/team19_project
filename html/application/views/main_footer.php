...
<!-- js-scripts -->			
	<!-- js 개인과제에 썻던걸로 바꿨어요
	<script type="text/javascript" src="/~team19/my/js/jquery-2.1.4.min.js"></script>
	<script type="text/javascript" src="/~team19/my/js/bootstrap.js"></script> 
	<!-- Necessary-JavaScript-File-For-Bootstrap --> 
	<!-- //js -->
	<!-- start-smoth-scrolling -->
	<script type="text/javascript" src="/~team19/my/myy/js/move-top.js"></script>
	<script type="text/javascript" src="/~team19/my/myy/js/easing.js"></script>
	...
	<!-- start-smoth-scrolling -->
	<!-- smooth scrolling -->
	<script src="/~team19/my/myy/js/SmoothScroll.min.js"></script>
	<!-- //smooth scrolling -->
	<!-- Easy Responsivetabs -->
	<script src="/~team19/my/myy/js/easyResponsiveTabs.js" type="text/javascript"></script>
	<script type="text/javascript">
	...
	<!-- //Easy Responsivetabs -->
	<!-- strat-date-piker -->
	<link rel="stylesheet" href="/~team19/my/myy/css/jquery-ui.css" />
	<script src="/~team19/my/myy/js/jquery-ui.js"></script>
	  <script>
			  $(function() {
	...
	<!-- //End-date-piker -->
	<!-- Numscroller -->
	<script type="text/javascript" src="/~team19/my/myy/js/numscroller-1.0.js"></script>
	<!-- //Numscroller -->
<!-- //js-scripts -->
</body>
</html>