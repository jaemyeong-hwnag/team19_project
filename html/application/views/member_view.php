...
<div class="alert mycolor1 mymargin15" role="alert">사용자</div>
	...
	<form name="form1" method="member_insert.html">
		...
		<div align="center">
			<a href="/~team19/member/edit/no/<?=$no;?>" class="btn btn-sm mycolor1">수정</a>
			<a href="/~team19/member/del/no/<?=$no;?>" class="btn btn-sm mycolor1" onClick="return confirm('삭제할까요?');">삭제</a>
