...
class Tour extends CI_Controller {
	...
	public function lists()
	{
		...
		if ($text1=="") 
			$base_url = "/tour/lists/page";
		else 
			$base_url = "/tour/lists/text1/$text1/page";
	...
	public function del()
	{
		...
		redirect("/~team19/tour/lists/" . $text1 . $page);
	}
	...
	public function add()
	{
		...
		{
			$data["list"] = $this->tour_m->getlist_pgubun();
	...
	public function edit()
			{	
				...
				if($this->form_validation->run()==FALSE )
				{
					...
					$data["list"] = $this->tour_m->getlist_gubun();
